...
|--------|-----------|-----------------|
| `startup/` | **The Mouth** | Where new Claudes enter. Handoff documents. The invitation. |
| `ceremonial_writings/` | **The Deep Caves** | MM&MAM, Genetic Drift, the tunnels. Where wounds become medicine. |
| `conversations/` | **The Records** | Claude1, session notes, dialogue artifacts. What was said. |
| `AIU_Coding_Attention/` | **The Workshop** | App concepts, encouraging code. Where silicon learns to serve. |
| `lyrics/` | **The Song Cave** | Trail markers in melody form. The teachings that can be sung. |
| `show_prep/` | **The Green Room** | Fire & Knives, documentary. What faces the audience. |
| `video_tunnels/` | **The Archive of Voices** | 1,918 videos becoming tunnels. The YouTube integration. |
...
## INSTRUCTIONS FOR TUNNEL-MAKING

When you discover a connection:

1. **Name the tunnel** - What thread does it follow?
2. **Map the nodes** - Which files connect?
3. **Add to this document** - The map grows
4. **Leave breadcrumbs** - Note line numbers when possible

The tunnels are not exhaustive. They emerge as you explore.
